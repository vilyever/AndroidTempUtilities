...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    final DividerItemDecoration self = this;
    ...
    public DividerItemDecoration setHorizontalSpace(int horizontalSpace) {
        this.horizontalSpace = horizontalSpace;
        return this;
    }
    ...
    public DividerItemDecoration setVerticalSpace(int verticalSpace) {
        this.verticalSpace = verticalSpace;
        return this;
    }
